...
public class RandomStudentGenerator {
    ...
    private final String[] lastNames = { "ADA", "KANDEMIR", "ATAK", "ERKURAN", "TASTAN", "OZTURK", "YAZICIOGLU",
            ...
            "TAHTACI", "BUYUKCAM", "KULAKSIZ", "AKSEL", "EROGLU", "KARAKUM", "DAL", "ALCAL", "AYHAN", "YIGIT",
            "YARBIL", "GUMUSAY", "MURT", "HALHALLI", "ULUYAZ", "AYHANLI", "YILMAZ", "SARACOGLU", "SEZER",
            "DOGAN", "DEMÄ°R", "KAYAYURT", "SURUM", "YAVASI", "TURGUT", "BARBAROS", "ALDINC", "TEKIN",
            "GULSAN", "KAFECI", "ALMACIOGLU", "CILDIR", "TURKDOGAN", "KAYA", "AKNER", "SELIMAN", "YAMAN",
            "ATA", "YIGIT", "GIRAY", "YALÃ‡INKAYA", "KILIC", "MERIC", "KARABAC", "DEGIRMENCI", "BODUROGLU",
            "YILDIZ", "GULER", "ERASLAN", "UZER", "PISIRGEN", "ADANIR", "KOC", "KORKMAZ", "YENIDOGAN", "AKSENER",
            "ACARBULUT", "ERGE", "KILIC", "DAROGLU", "SOYLU", "PEKER", "PEKTAS", "KAYACAN", "GULEN", "DOGAN",
