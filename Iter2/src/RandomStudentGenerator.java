...
/**
 * The RandomStudentGenerator class that creates random students with all
 * randomized information and contains related methods
 */
public class RandomStudentGenerator {
    /**
     * Student first names String array
     */
    private final String[] firstNames = { "JALE", "ALI", "MAHMUT", "MANSUR", "GAMZE", "MAHMUT", "YUCEL", "KUBILAY",
            "HAYATI", "BEDRIYE MUGE", "BIRSEN", "SERDAL", "BUNYAMIN", "OZGUR", "FERDI", "REYHAN", "ILHAN", "GULSAH",
            "NALAN", "SEMIH", "ERGIN", "FATIH", "SENAY", "SERKAN", "EMRE", "BAHATTIN", "IRAZCA", "HATICE", "BARIS",
            "REZAN", "FATIH", "FUAT", "GOKHAN", "ORHAN", "MEHMET", "EVREN", "OKTAY", "HARUN", "YAVUZ", "PINAR",
            "MEHMET", "UMUT", "MESUDE", "HUSEYIN CAHIT", "HASIM ONUR", "EYYUP SABRI", "MUSTAFA", "UFUK", "AHMET ALI",
            "MEDIHA", "HASAN", "KAMIL", "NEBI", "OZCAN", "NAGIHAN", "CEREN", "SERKAN", "HASAN", "YUSUF KENAN", "TARKAN",
            "MERAL LEMAN", "ERGIN", "KENAN AHMET", "URAL", "YAHYA", "BENGU", "FATIH NAZMI", "DILEK", "MEHMET",
            "TUFAN AKIN", "MEHMET", "TURGAY YILMAZ", "GULDEHEN", "GOKMEN", "BULENT", "EROL", "BAHRI", "OZLEM", "SELMA",
            "TUGSEM", "NAZLI", "MURAT", "EBRU", "AHMET", "HUSEYIN YAVUZ", "BASAK", "AYSEGUL", "EVRIM", "YASER", "ULKU",
            "OZHAN", "UFUK", "AKGUL", "FULYA", "BURCU", "TAYLAN", "YILMAZ", "ZEYNEP", "BAYRAM", "GULAY", "RABIA",
            "SEVDA", "SERHAT", "ENGIN", "ASLI", "TUBA", "BARIS", "SEVGI", "KALENDER", "HALIL", "BOLGE", "FERDA", "EZGI",
            "AYSUN", "SEDA", "OZDEN", "KORAY", "SENEM", "ZEYNEP", "EMEL", "BATURAY KANSU", "NURAY", "AYDOGAN", "DENIZ",
            "ILKNUR", "TEVFIK", "HASAN SERKAN", "KIRAC", "SEYFI", "SEYMA", "ERSAGUN", "DILBER", "MESUT", "ELIF",
            "MUHAMMET FATIH", "OZGUR SINAN", "MEHMET OZGUR", "MAHPERI", "ONUR", "FARAH ZEYNEP", "VOLKAN", "HALE",
            "YENER", "SEDEF", "FADIL", "SULTAN", "MUAMMER HAYRI", };
    /*
     * Student last names String array
     */
    private final String[] lastNames = { "ADA", "KANDEMIR", "ATAK", "ERKURAN", "TASTAN", "OZTURK", "YAZICIOGLU",
            "VURAL", "YUCEL", "SONMEZ", "ERTEKAN", "DEDE", "UYANIK", "ASLAN", "AKBULUT", "ORHON", "UZ", "YAVUZ",
            "ERDEM", "KULAC", "KAYA", "SELVA", "AKPINAR", "ABACIOGLU", "ATAY", "ISIK", "ALZER", "OZDEMIR", "OZTURK",
            "TAHTACI", "BUYUKCAM", "KULAKSIZ", "AKSEL", "EROÄ�LU", "KARAKUM", "DAL", "Ã–CAL", "AYHAN", "YÄ°Ä�Ä°T",
            "YARBÄ°L", "GÃœMÃœÅ�AY", "MURT", "HALHALLI", "ULUÃ–Z", "Å�EYHANLI", "YILMAZ", "SARAÃ‡OÄ�LU", "SEZER",
            "DOÄ�AN", "DEMÄ°R", "KAYAYURT", "SÃœRÃœM", "YAVAÅ�Ä°", "TURGUT", "BARBAROS", "ALDÄ°NÃ‡", "TEKÄ°N",
            "GÃœLÅ�AN", "KÃœFECÄ°LER", "ALMACIOÄ�LU", "Ã‡Ä°LDÄ°R", "TÃœRKDOÄ�AN", "KAYA", "AKNER", "Å�ELÄ°MAN", "YAMAN",
            "ATÄ°K", "YÄ°Ä�Ä°T", "GÄ°RAY", "YALÃ‡INKAYA", "KILIÃ‡", "MERIC", "KARABAC", "DEGIRMENCI", "BODUROGLU",
            "YILDIZ", "GULER", "ERASLAN", "UZER", "PISIRGEN", "ADANIR", "KOC", "KORKMAZ", "YENIDOGAN", "AKSENER",
            "ACARBULUT", "ERGE", "KILICDAROGLU", "ERDOGAN", "SOYLU", "PEKER", "PEKTAS", "KAYACAN", "GULEN", "DOGAN",
            "CANDAN", "TEMEL", "YENGAVER", "YILDIRIM", "BEDER", "AKINCI", "OZDEMIR", "ONUK", "AYDOGAN", "YILMAZ",
            "COMERT", "TOPAL", "KARAHAN", "ATAHAN", "AYTEN", "AYTAS", "KACAR", "GUNDUZ", "AK", "URFALI", "KARAMAN",
            "MEHMETOGLU", "KAZBEK", "AGAOGLU", "AKIN", "YURDAGUL", "YUKSEL", "MERIC", "BABUS", "KAPLAN", "GANIZ",
            "KARTAL", "BAS", "ERDEN", "TUGRUL", "KUMRAL", "ERBAS", "ORAL", "KILIC", "CENGIZ", "YILDIRIM", "BALABAN" };
    /**
        ...
        try {
            ...
            for (Student student : students) {
                ...
                for (Map.Entry<DepartmentCourse, StudentCourse> course : student.getNewlyTakenCourses().entrySet()) {
                    studentLog.append("He/She taken ").append(course.getValue().getMainCourse().getCourseName())
                            .append(" this year \n");
                }
